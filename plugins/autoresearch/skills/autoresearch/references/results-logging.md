...
```
run_id	iteration	commit	metric	delta	guard	status	description	tags	duration_sec
```
...
| tags         | string | Optional comma-separated categories: `refactor`, `feature`, `fix`, `perf`, `docs`, `test`. Use `-` if none. |
...
autoresearch/20260331-0100	1	def5678	45	+3	pass	keep	Optimized database query in users.ts	perf	145
autoresearch/20260331-0100	2	-	44	-1	pass	discard	Tried caching layer, slight regression	perf	92
autoresearch/20260331-0100	3	ghi9012	46	+1	pass	keep	Removed unused imports reducing parse time	refactor	78
autoresearch/20260331-0100	4	-	46	0	pass	discard	Refactored loop --- no improvement	refactor	110
